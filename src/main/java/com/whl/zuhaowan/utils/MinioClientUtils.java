...
public class MinioClientUtils {
     ...
     * @return
     */
    public Iterable<Result<Item>> listObjects(String bucketName, String preFix) throws XmlParserException, IOException, InvalidResponseException, InvalidKeyException, NoSuchAlgorithmException, ServerException, ErrorResponseException, InvalidBucketNameException, InsufficientDataException, InternalException {
        boolean flag = bucketExists(bucketName);
        if (flag && null != preFix) {
