...
public class SendSmsUtils {
    ...
    public static void main(String[] args) {
        SendSmsUtils sendSmsDemo = new SendSmsUtils();
        try {
            // 创建短信模板
    ...
    private DefaultProfile profile = DefaultProfile.getProfile(
            ...
            "LTAI5tFxWe5GM559hYGzcS1g",// 您的AccessKey ID。
            "yzFouZLRUuTCxye9nmjnFjxAw7Ap66q");// 您的AccessKey Secret。
    ...
    private String sendSms(String templateCode) throws ClientException {
        ...
        // 接收短信的手机号码
        request.putQueryParameter("PhoneNumbers", "18851100167");
    ...
    private void querySendDetails(String bizId) throws ClientException {
        ...
        // 接收短信的手机号码
        request.putQueryParameter("PhoneNumber", "18851100167");
