package com.whl.zuhaowan.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    FORMAT_NAME_REPEAT(4000004,"格式名已存在"),
    ...
    TOKEN_PAST_INVALID(4010003,"无效token,请检查token格式"),
    ...
    FILE_UPLOAD_ERROR(4010017,"文件上传失败"),
    PAAS_LOGIN_ERROR(6010001,"PaaS平台登录异常"),
    PAAS_DATASET_ERROR(6010002,"PaaS平台操作异常"),
    ;
